              ...
              <div>
                  ...
                  <div className="space-y-4">
                      <div>
                          ...
                          <div className="text-slate-300 font-mono text-sm">AlexeZav@gmail.com</div>
                      </div>
                      ...
                      <div>
                          ...
                          <div className="text-slate-300 font-mono text-sm">+380 73 788 21 98</div>
                          <div className="text-slate-300 font-mono text-sm">olga.kalga@gmail.com</div>
                      </div>
                  </div>
              </div>
